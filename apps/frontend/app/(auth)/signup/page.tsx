    ...
    <div className="flex min-h-screen bg-bg-base overflow-hidden items-center justify-center p-4">
      <div className="w-full max-w-md bg-bg-surface border border-border-strong rounded-2xl p-8 shadow-2xl relative overflow-hidden">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h1 className="text-xl font-bold text-white tracking-tight">Access Request</h1>
            <p className="text-xs text-text-tertiary">Karnataka State Police Intelligence Network</p>
          </div>
        </div>
        ...
        {submitted ? (
          ...
          >
            ...
            <p className="text-xs text-text-secondary mb-6 leading-relaxed">
              Your access registration request for badge <span className="font-mono text-brand-400 font-bold">{badgeNumber}</span> has been routed to your District Administrator for verification.
            </p>
            <Link
              href="/login"
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-xs font-medium text-text-secondary mb-1.5">Official KSP Email Address</label>
              <input
                type="email"
                required
                value={email}
            ...
            >
              Submit Registration Request <ArrowRight className="w-4 h-4" />
            </button>
