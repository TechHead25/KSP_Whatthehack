// ============================================================
// NETRA AI — Navigation Configuration
// Source: UI_DESIGN_SYSTEM.md §9 Navigation Structure
// FROZEN — Do not modify without user instruction
// ============================================================

import type { NavGroup } from '@netra/types'

/**
 * Full sidebar navigation config.
 * Visibility is controlled at runtime by role/permission checks.
 * Keep structure alphabetical within groups for maintainability.
 */
...
/** Route → page title mapping for breadcrumbs and <title> tags */
